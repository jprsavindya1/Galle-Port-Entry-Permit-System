    ...
    <div class="user-dashboard-card">
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">Minimum 8 characters (if changing password)</small>
            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validatePasswordMatch() {
            // If password field is empty, no validation needed (password is optional for edit)
        ...
        function validatePasswordStrength() {
            ...
            // Only validate if password is not empty (since it's optional for edit)
        ...
        form.addEventListener('submit', function(e) {
            ...
            // Only check password match if password field has a value
            if (password.value !== '') {
