...
<head>
    ...
    <style>
        ...
        /* Back to invoice */
        #btnBackInvoice{
            background-color: #5e8eb8ff;
        }
        #btnBackInvoice:hover {
            background-color: #4b7699;
            box-shadow: 0 5px 12px rgba(94, 142, 184, 0.4);
        }
    </style>
</head>
<body>
    ...
    <div id="printControls">
        ...
        <button id="btnBack">Back to View Submitted Permits</button>
    </div>
    ...
    <script>
        ...
        document.getElementById('btnBack').addEventListener('click', function() {
            window.location.href = "{{ route('permits.submitted') }}";
        });
