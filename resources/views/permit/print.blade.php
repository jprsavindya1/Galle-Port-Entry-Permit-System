...
<style>
    ...
    @media print {
        ...
        .permit-container { box-shadow: none !important; border: 2px solid #000 !important; margin: 0 0 20px 0 !important; }
        .permit-container:not(:last-child) { page-break-after: always; }
    }
