    ...
    <div class="user-dashboard-card mx-auto" style="max-width:720px;">
        ...
        <form action="{{ route('blacklist.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="company_name" id="company_name" class="form-control" value="{{ old('company_name') }}" style="text-transform: uppercase;" oninput="checkFormValidity()" onblur="checkFormValidity()">
            </div>

            <div class="mb-3">
                <label for="vehicle_number" class="form-label">Vehicle Number</label>
                <input type="text" name="vehicle_number" id="vehicle_number" class="form-control" value="{{ old('vehicle_number') }}" style="text-transform: uppercase;" placeholder="e.g., ABC-1234" oninput="validateVehicleNumber()" onblur="validateVehicleNumber()">
                <span id="vehicle_number_error" class="text-danger" style="font-size: 0.875rem;"></span>
            </div>

            <div class="mb-3">
                <label for="reason" class="form-label">Reason <span class="text-danger">*</span></label>
                <textarea name="reason" id="reason" class="form-control" required oninput="checkFormValidity()" onblur="checkFormValidity()">{{ old('reason') }}</textarea>
            </div>
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" id="submitBtn" class="btn btn-primary me-2" disabled style="opacity: 0.65; cursor: not-allowed;"><i class="bi bi-plus-circle me-1"></i> Add Entry</button>
