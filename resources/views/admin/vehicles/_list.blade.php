...
<div class="container" id="vehicle-list-container">
    <div class="company-dashboard-card">
        ...
        <form id="vehicle-search-form" method="GET" action="{{ route('admin.vehicles.index') }}" class="row g-3 mb-3 align-items-end ajax-search-form" style="background:linear-gradient(135deg,#e3f2fd 0%,#f8fafc 100%);border-radius:0.75rem;padding:0.75rem;">
            ...
            <div class="col-md-2">
                <a href="{{ route('admin.vehicles.index') }}" class="btn btn-secondary w-100" style="border-radius:0.5rem;font-weight:500;"><i class="bi bi-arrow-clockwise"></i> Reset</a>
            </div>
        </form>
    ...
    if (searchForm) {
        searchForm.addEventListener('submit', function(e) {
            ...
            fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                ...
                .then(html => { document.getElementById('vehicle-list-container').innerHTML = html; })
