...
<div class="form-card">
    <form action="{{ $action }}" method="POST" class="ajax-form">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $reason->name ?? '') }}" required style="border-radius:0.5rem;border:1px solid #bbdefb;background:#fff">
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('admin.reasons.index') }}" class="btn btn-cancel ajax-link" style="border-radius:0.5rem;margin-left:0.5rem;"><i class="bi bi-x-lg me-1"></i> Cancel</a>
        </div>
    </form>
</div>
