...
<div class="container" id="company-list-container">
    <div class="company-dashboard-card">
        <div class="company-dashboard-header">
            ...
            <a href="{{ route('admin.companies.create') }}" class="btn btn-success ajax-link" style="border-radius:0.5rem;font-weight:500;"><i class="bi bi-plus-lg me-1"></i> Add New Company</a>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="{{ route('admin.companies.edit', $company) }}" class="company-action-btn edit btn btn-sm ajax-link"><i class="bi bi-pencil-square me-1"></i> Edit</a>
                                <form action="{{ route('admin.companies.destroy', $company) }}" method="POST" class="ajax-delete" data-reload-url="{{ route('admin.companies.index') }}">
                                    @csrf @method('DELETE')
