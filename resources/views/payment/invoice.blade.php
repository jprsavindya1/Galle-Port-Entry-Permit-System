...
<div id="print-area" class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0"><strong>Payment Invoice - </strong></h2><h5>{{ $payment->invoice_id }}</h5>
    ...
    @elseif($payment->permit_type === 'MP')
        ...
        <a href="{{ route('permit.vehicle') }}" class="btn btn-secondary mt-4">Back to Vehicle Permit Form</a>
    @else
...
<!-- Print Permit Button -->
<a href="{{ route('permit.print', $submission_id) }}" target="_blank" class="btn btn-primary mt-2">Batch Print</a>

@endsection

<style>
@media print {
    body * { visibility: hidden !important; height: 0 !important; margin: 0 !important; padding: 0 !important; overflow: visible !important; }
    #print-area, #print-area * { visibility: visible !important; height: auto !important; margin: 0 !important; padding: 0 !important; overflow: visible !important; }
    #print-area { position: absolute !important; left: 0 !important; top: 0 !important; width: 100% !important; padding: 1cm !important; background: white !important; }
    #print-area .btn { display: none !important; }
    table { width: 100% !important; border-collapse: collapse !important; font-size: 12pt; }
    th, td { border: 1px solid black !important; padding: 6px !important; text-align: left; }
    thead { display: table-header-group !important; background-color: #f0f0f0 !important; }
