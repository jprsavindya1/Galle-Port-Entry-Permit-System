<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="flex items-center gap-3">
            ...
            <button type="submit"
                    style="background: linear-gradient(135deg, #13314C 0%, #1a4063 100%);"
                    ...
                    onmouseover="this.style.background='linear-gradient(135deg, #1a4063 0%, #245887 100%)'"
                    onmouseout="this.style.background='linear-gradient(135deg, #13314C 0%, #1a4063 100%)'">
